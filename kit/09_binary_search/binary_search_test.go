...
func TestBinarySearchRecursive(t *testing.T) {
    ...
    if BinarySearchRecursive(a, 8) != 4 {
        t.Fatal(BinarySearchRecursive(a, 3))
    }
    if BinarySearchRecursive(a, 4) != -1 {
        t.Fatal(BinarySearchRecursive(a, 4))
    }
}
...
func TestBinarySearchFirstSimple(t *testing.T) {
    var a []int

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstSimple(a, 2) != 1 {
        t.Fatal(BinarySearchFirstSimple(a, 2))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstSimple(a, 3) != 4 {
        t.Fatal(BinarySearchFirstSimple(a, 3))
    }
}
...
func TestBinarySearchFirstGT(t *testing.T) {
    ...
    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstGT(a, 1) != 0 {
        t.Fatal(BinarySearchFirstGT(a, 1))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstGT(a, 3) != 4 {
        t.Fatal(BinarySearchFirstGT(a, 3))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstGT(a, 4) != 5 {
        t.Fatal(BinarySearchFirstGT(a, 4))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchFirstGT(a, 5) != -1 {
        t.Fatal(BinarySearchFirstGT(a, 5))
    }
}
...
func TestBinarySearchLastLT(t *testing.T) {
    ...
    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchLastLT(a, 2) != 3 {
        t.Fatal(BinarySearchLastLT(a, 2))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchLastLT(a, 1) != 0 {
        t.Fatal(BinarySearchLastLT(a, 1))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchLastLT(a, 3) != 4 {
        t.Fatal(BinarySearchLastLT(a, 3))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchLastLT(a, 4) != 5 {
        t.Fatal(BinarySearchLastLT(a, 4))
    }

    a = []int{1, 2, 2, 2, 3, 4}
    if BinarySearchLastLT(a, 0) != -1 {
        t.Fatal(BinarySearchLastLT(a, 0))
    }
}